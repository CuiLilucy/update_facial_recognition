...
import com.example.myapp5.recordUtils.PermissionUtil;
...
public class RecordActivity extends AppCompatActivity {
    ...
    private static File tmpOutFile;
     ...
     * 录音数队列
     */
    private final ConcurrentLinkedQueue<byte[]> audioQueue = new ConcurrentLinkedQueue<byte[]>();
    private final ThreadPoolExecutor mExecutor = new ThreadPoolExecutor(2, 2, 60, TimeUnit.SECONDS,
...
//                , AudioTrack.MODE_STREAM);
    ...
    void onClickStart(View view) {
        ...
        showToast("检测中bb");
        File tmpFile = createFile(tmpName + ".pcm");

        tmpOutFile = createFile(tmpName + ".wav");
        String mTmpFileAbs = tmpFile.getAbsolutePath();
        mLogTv.setText(mTmpFileAbs);
    ...
    public static File getTmpOutFile() {
        return tmpOutFile;
    }
}